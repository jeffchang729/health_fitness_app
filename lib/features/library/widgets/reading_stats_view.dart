// lib/features/library/widgets/reading_stats_view.dart
...
class ReadingStatsView extends StatelessWidget {
  ...
  const ReadingStatsView({Key? key, this.animationController, this.animation})
      : super(key: key);
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            width: 4, color: AppTheme.nearlyDarkBlue.withOpacity(0.2)),
                                      ),
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  Padding(
                                    ...
                                    child: CustomPaint(
                                      painter: CircleProgressPainter(
                                          ...
                                          angle: 270 + (360 - 270) * (1.0 - animation!.value)),
...
class CircleProgressPainter extends CustomPainter {
  ...
  CircleProgressPainter({this.colors, this.angle = 270});
